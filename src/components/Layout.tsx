...
export const PHONE_NUMBER = "918053267951";
...
export function Layout() {
  ...
  return (
    <div className="min-h-screen bg-[#fdfbf4] font-sans text-gray-800 flex flex-col">
          ...
          <div className="flex justify-between h-20">
            <div className="flex items-center">
              <Link to="/" className="flex-shrink-0 flex items-center">
                <span className="text-[#1e3a5f] font-bold text-2xl tracking-wider">JAGANNATH PURI STAY</span>
              </Link>
            </div>
      ...
      {/* Footer */}
      <footer className="bg-[#1e3a5f] text-white pt-16 pb-8 mt-auto border-t-4 border-[#eab308]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            {/* About Us */}
            <div>
              <h3 className="text-xl font-bold mb-6 text-[#eab308]">About Us</h3>
              <p className="text-sm text-gray-300 leading-relaxed">
                <strong>Jagannath Puri Stay</strong> is the best in class service of budget accommodation in Puri, offering options for pilgrims, seniors, and families. Clean and accessible amenities near the temple and beach.
              </p>
            </div>
            {/* Quick Links */}
            <div>
              <h3 className="text-xl font-bold mb-6 text-[#eab308]">Quick Links</h3>
            ...
            {/* Work Hours */}
            <div>
              <h3 className="text-xl font-bold mb-6 text-[#eab308]">Work Hours</h3>
            ...
            {/* Contact Info */}
            <div>
              <h3 className="text-xl font-bold mb-6 text-[#eab308]">Contact Info</h3>
              <ul className="space-y-4 text-sm text-gray-300">
                <li className="flex items-start">
                  <MapPin className="mr-3 h-5 w-5 flex-shrink-0 text-[#eab308]" />
                  <span>Grand Road, Near Jagannath Temple<br />Puri, Odisha 752001</span>
                </li>
                <li className="flex items-center">
                  <Phone className="mr-3 h-5 w-5 flex-shrink-0 text-[#eab308]" />
                  <a href={`tel:+${PHONE_NUMBER}`} className="hover:text-white transition">+91 80532 67951</a>
                </li>
                <li className="flex items-center">
                  <Mail className="mr-3 h-5 w-5 flex-shrink-0 text-[#eab308]" />
                  <a href="mailto:info@jagannathpuristay.com" className="hover:text-white transition">info@jagannathpuristay.com</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-sm text-gray-400 text-center md:text-right">
              © {new Date().getFullYear()} all Rights reserved to Jagannath Puri Stay
            </p>
          </div>
        </div>
      </footer>
