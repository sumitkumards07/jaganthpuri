            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Grand Road, Near Jagannath Temple<br />Puri, Odisha 752001<br />India</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">
                    <a href={`tel:+${PHONE_NUMBER}`} className="hover:text-[#1e3a5f] transition">+91 80532 67951</a>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">
                    <a href="mailto:info@jagannathpuristay.com" className="hover:text-[#1e3a5f] transition">info@jagannathpuristay.com</a>
                  </p>
                </div>
              </div>
