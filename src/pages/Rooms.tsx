    ...
    <section id="rooms" className="pt-20">
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">Choose from our range of comfortable and affordable rooms designed to make your stay in Puri pleasant and peaceful.</p>
        </div>
